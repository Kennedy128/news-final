...
class TestNews(unittest.TestCase):
    ...
    def setUp(self):
        ...
        '''
        self.new_news_source = News('abc','Kennedy','https://abc.com/','abc news is the best source', 'usa', 'general', 'abc-news')
    ...
    def test_to_check_instance_variables(self):
        ...
        self.assertEquals(self.new_news_source.author,'Kennedy')
